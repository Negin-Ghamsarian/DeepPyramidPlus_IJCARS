...
class DeepPyramid_ResNet50_FFD_LayerNorm(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=True, Pyramid_Loss=False, init_shape = [512, 512]):
        super(DeepPyramid_ResNet50_FFD_LayerNorm, self).__init__()
        ...
        self.up1 = Up(2048+1024, 512, [3, 6, 7], [init_shape[0]//8, init_shape[1]//8], bilinear)
        self.up2 = Up(1024, 256, [3, 6, 7], [init_shape[0]//4, init_shape[1]//4], bilinear)
        self.up3 = Up(512, 64, [3, 6, 7], [init_shape[0]//2, init_shape[1]//2], bilinear)
...
if __name__ == '__main__':
    ...
    model_without_PyramidLoss = DeepPyramid_ResNet50_FFD_LayerNorm(n_channels=3, n_classes=1, bilinear=True, Pyramid_Loss=False)
    ...
    model_with_PyramidLoss = DeepPyramid_ResNet50_FFD_LayerNorm(n_channels=3, n_classes=1, bilinear=True, Pyramid_Loss=True)
